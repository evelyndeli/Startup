...
public class Objeto {
    ...
    private boolean costemodificado = false;
    ...
    public void addAlquilerAlObjeto (int idPer, int idObj,float coste ,Date fecha_iniTemp, Date fecha_finTemp, String auxNombre){
        //comprobamos si el objeto esta disponible en estas fechas
    ...
    // funcion para guardar en el fichero
    public String guardarObjeto(){
        String s;
    ...
    public void modificarCoste(float newCoste){
        this.coste = newCoste;
        this.costemodificado = true;
    }
